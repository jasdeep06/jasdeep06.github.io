...
$.ajax({
    ...
    data: JSON.stringify({'head': localStorage.getItem("view"),'action':"views"}),
}).done(function( msg ) {
   console.log(msg);
...
function scrollThere(targetElement, speed) {
  ...
  $('html, body , #contentload').stop().animate(
    { scrollTop: postionOfTargetElement + scrollPosition - 147}, // move window so target element is at top of window
...
function fb_share(){
   ...
   var uri=encodeURIComponent("https://jasdeep06.github.io/knowmapwebdisp/index.html#"+window.location.hash.substring(1))

    window.open("https://www.facebook.com/sharer/sharer.php?u="+uri, 'fbShareWindow', 'height=450, width=550, top=' + ($(window).height() / 2 - 275) + ', left=' + ($(window).width() / 2 - 225) + ', toolbar=0, location=0, menubar=0, directories=0, scrollbars=0');
...
function linkedin_share(){
   ...
   var uri=encodeURIComponent("https://jasdeep06.github.io/knowmapwebdisp/index.html#"+window.location.hash.substring(1))
    ...
    //window.open("https://www.facebook.com/sharer/sharer.php?u="+uri, 'fbShareWindow', 'height=450, width=550, top=' + ($(window).height() / 2 - 275) + ', left=' + ($(window).width() / 2 - 225) + ', toolbar=0, location=0, menubar=0, directories=0, scrollbars=0');
window.open("https://www.linkedin.com/shareArticle?mini=true&url="+"https://jasdeep06.github.io/knowmapwebdisp/index.html#"+window.location.hash.substring(1),'fbShareWindow', 'height=450, width=550, top=' + ($(window).height() / 2 - 275) + ', left=' + ($(window).width() / 2 - 225) + ', toolbar=0, location=0, menubar=0, directories=0, scrollbars=0')
...
function twitter_share(){
   ...
   var uri=encodeURIComponent("https://jasdeep06.github.io/knowmapwebdisp/index.html#"+window.location.hash.substring(1))
    ...
    //window.open("https://www.facebook.com/sharer/sharer.php?u="+uri, 'fbShareWindow', 'height=450, width=550, top=' + ($(window).height() / 2 - 275) + ', left=' + ($(window).width() / 2 - 225) + ', toolbar=0, location=0, menubar=0, directories=0, scrollbars=0');
window.open("https://twitter.com/share?text='This is a great Knowledge Book that I found!!'&url="+uri,'fbShareWindow', 'height=450, width=550, top=' + ($(window).height() / 2 - 275) + ', left=' + ($(window).width() / 2 - 225) + ', toolbar=0, location=0, menubar=0, directories=0, scrollbars=0')
